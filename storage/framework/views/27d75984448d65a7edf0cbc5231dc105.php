...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> - Music Town</title>
...
<body>
    ...
    <aside class="admin-sidebar" id="admin-sidebar">
        ...
        <div class="sidebar-footer">
            <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('layout-logout').submit();">
                <span class="icon">&#8617;</span> Logout
            </a>
            <form id="layout-logout" method="POST" action="<?php echo e(route('logout')); ?>" style="display:none;"><?php echo csrf_field(); ?></form>
        </div>
    </aside>
    ...
    <main class="admin-main">
        <div class="admin-topbar">
            ...
            <div class="admin-user">
                ...
                <small style="color:var(--muted);font-weight:600;font-size:0.75rem;text-transform:uppercase;"><?php echo e(Auth::user()->role ?? 'admin'); ?></small>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\music\resources\views/layouts/admin.blade.php ENDPATH**/ ?>