...
<body>
    <main class="auth-page">
        ...
        <section class="auth-shell">
            ...
            <form class="auth-card" method="POST" action="<?php echo e(route('signup.submit')); ?>">
                <?php echo csrf_field(); ?>
                <?php if($ref = request()->query('ref')): ?>
                ...
                <label>
                    Full name
                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Your full name" autocomplete="name" required>
                </label>
...
<?php /**PATH C:\xampp\htdocs\music\resources\views/auth/signup.blade.php ENDPATH**/ ?>