...
<?php $__env->startSection('content'); ?>
        <section style="max-width:700px;margin:0 auto;">
            ...
            <div class="auth-card" id="withdrawCard">
                ...
                <label>
                    Amount (₦)
                    <input type="number" id="amount" placeholder="Minimum ₦10,000" min="10000" max="<?php echo e($user->balance); ?>" step="0.01">
                    <span style="font-size:0.8rem;color:var(--muted);font-weight:400;">Minimum withdrawal: ₦10,000</span>
                </label>

                <div class="withdrawal-info">
                    <span>Balance: <strong>₦<?php echo e(number_format($user->balance, 2)); ?></strong></span>
                    <?php if($user->tier !== 'tier0'): ?>
                        <?php
                        ...
                        ?>
                        <span>Withdrawals left: <strong><?php echo e(max(0, $remaining)); ?></strong></span>
                    <?php endif; ?>
                </div>
        ...
        <div id="upgrade-modal" class="modal-overlay">
            <div class="modal-box">
                ...
                <div class="modal-actions">
                    ...
                    <a class="button" href="<?php echo e(route('profile.upgrade.form')); ?>" style="flex:1;text-decoration:none;text-align:center;">Continue to Upgrade</a>
                </div>
            </div>
        </div>
    ...
    <script>
        // ---------- CONFIG ----------
        const API_BANKS_URL = "<?php echo e(route('banks')); ?>";
        ...
        const withdrawRoute = '<?php echo e(route('profile.withdraw')); ?>';
        const verifyRoute = '<?php echo e(route('verify.account')); ?>';
        ...
        const userTier = '<?php echo e($user->tier); ?>';
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\music\resources\views/premium/index.blade.php ENDPATH**/ ?>